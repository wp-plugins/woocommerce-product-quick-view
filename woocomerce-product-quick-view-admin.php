...
<div class="main-content">
    <div clas="head">
        <h3>Quick View Admin Settings.</h3>
    </div>
    <form name="qv_form" class="qv_form" method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
        ...
        <p><?php _e("Quick View Custom Text: "); ?><input type="text" name="quick_view_text" id="quick_view_text" style="<?php if(!empty($text)){echo 'border: 1px dotted #ff0000;';}?>" value="<?php echo $quick_view_text; ?>"><?php if(!empty($text)){_e('Field cantt be blank'); }else{ _e(' Quick View by default');} ?></p>
        <br />    
        <p><?php _e("Quick View Button Color: "); ?><input class="color {hash:true}" type="text" name="quick_view_color" value="<?php echo $quick_view_color; ?>"><?php _e('#ec4918 by default.'); ?></p>
        <br />    
        <p><?php _e("Quick View Font Color: "); ?><input class="color {hash:true}" type="text" name="quick_view_font_color" value="<?php echo $quick_view_font_color; ?>"><?php _e('#ffffff by default.'); ?></p>
        <br />    
        <hr />	
        <p class="submit">  
